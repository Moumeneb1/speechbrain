...
class ASR(sb.core.Brain):
    ...
    def on_stage_end(self, stage, stage_loss, epoch=None):
        ...
        if stage == sb.Stage.VALID:
            ...
            (
                old_lr_wav2vec2,
                new_lr_wav2vec2,
            ) = self.hparams.lr_annealing_wav2vec(stats["error_rate"])
    ...
    def init_optimizers(self):
        ...
        self.wav2vec2_optimizer = self.hparams.wav2vec_opt_class(
...
def dataio_prepare(hparams):
    ...
    @sb.utils.data_pipeline.takes("age_classes")
