...
class SLU(sb.Brain):
    ...
    def on_stage_end(self, stage, stage_loss, epoch):
        ...
        if stage == sb.Stage.TRAIN:
            ...
            stage_stats["WER_intent"] = self.wer_metric_intents.summarize("error_rate")
            stage_stats["WER_slots"] = self.wer_metric_slots.summarize("error_rate")
            stage_stats["WER_all"] = self.wer_metric_all.summarize("error_rate")
