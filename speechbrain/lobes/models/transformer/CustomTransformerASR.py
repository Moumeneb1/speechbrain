...
class CustomTransformerASR(TransformerInterface):
    ...
    def __init__(
        ...
        self.encoder_model  = ORTModule(encoder_model)
    ...
    def forward(self, src, tgt, wav_len=None, pad_idx=0):
        ...
        encoder_out = self.encoder_model(src)
        ...
        (
            ...
            src_mask,
            tgt_mask,
        ) = self.make_masks(encoder_out, tgt, wav_len, pad_idx=pad_idx)
